...
public class MapNavigationMesh
{
    ...
    private void populationMesh()
    {
        ...
        agri_engineer_north_ent.setLeft(new LatLng(49.807577, -97.133863), new XYPos(-47, -174));
        agri_engineer_north_ent.setRight(new LatLng(49.807589, -97.133770), new XYPos(-40, -173));
        agri_engineer_north_ent.setBottom(new LatLng(49.807491, -97.133790), new XYPos(-41, -184));
        ...
        agri_engineer_south_ent.setLeft(new LatLng(49.807456, -97.134232), new XYPos(-73, -188));
        agri_engineer_south_ent.setRight(new LatLng(49.807472, -97.134153), new XYPos(-68, -186));
        agri_engineer_south_ent.setBottom(new LatLng(49.807406, -97.134132), new XYPos(-66, -193));
        ...
        agriculture_north_ent.setLeft(new LatLng(49.807141, -97.135138), new XYPos(-138, -223));
        agriculture_north_ent.setRight(new LatLng(49.807172, -97.135082), new XYPos(-134, -219));
        agriculture_north_ent.setBottom(new LatLng(49.807100, -97.135065), new XYPos(-133, -227));
        ...
        agriculture_south_ent.setLeft(new LatLng(49.806997, -97.135575), new XYPos(-170, -239));
        agriculture_south_ent.setRight(new LatLng(49.807014, -97.135511), new XYPos(-165, -237));
        agriculture_south_ent.setBottom(new LatLng(49.806958, -97.135498), new XYPos(-164, -243));
        ...
        allen_armes_parker.setLeft(new LatLng(49.810950, -97.134629), new XYPos(-102, 201));
        allen_armes_parker.setRight(new LatLng(49.810993, -97.134347), new XYPos(-81, 206));
        ...
        allen_armes.setLeft(new LatLng(49.810449, -97.134508), new XYPos(-93, 145));
        allen_armes.setRight(new LatLng(49.810614, -97.134037), new XYPos(-59, 164));
        allen_armes.setBottom(new LatLng(49.810471, -97.134296), new XYPos(-78, 148));
        ...
        animal_sci_north_ent.setLeft(new LatLng(49.806251, -97.137814), new XYPos(-330, -322));
        animal_sci_north_ent.setRight(new LatLng(49.806315, -97.137570), new XYPos(-313, -314));
        animal_sci_north_ent.setBottom(new LatLng(49.806214, -97.137599),new XYPos(-315, -326));
        ...
        animal_sci_south_ent.setLeft(new LatLng(49.806112, -97.138202), new XYPos(-358, -337));
        animal_sci_south_ent.setRight(new LatLng(49.806138, -97.138101), new XYPos(-351, -334));
        animal_sci_south_ent.setBottom(new LatLng(49.806032, -97.138085), new XYPos(-350, -346));
        ...
        archi2_north_ent.setTop(new LatLng(49.808076, -97.136310), new XYPos(-222, -119));
        archi2_north_ent.setRight(new LatLng(49.808017, -97.136158), new XYPos(-211, -125));
        archi2_north_ent.setBottom(new LatLng(49.807970, -97.136214), new XYPos(-215, -130));
        ...
        archi2_south_ent.setTop(new LatLng(49.807786, -97.136334), new XYPos(-224, -151));
        archi2_south_ent.setBottom(new LatLng(49.807725, -97.136278), new XYPos(-220, -158));
        ...
        armes_machray.setTop(new LatLng(49.810997, -97.133403), new XYPos(-14, 206));
        armes_machray.setRight(new LatLng(49.811023, -97.133166), new XYPos(-3, 209));
        ...
        artlab.setTop(new LatLng(49.808661, -97.130542), new XYPos(192, -54));
        artlab.setRight(new LatLng(49.808648, -97.130393), new XYPos(202, -55));
        artlab.setBottom(new LatLng(49.808326, -97.130296), new XYPos(209, -91));
        ...
        bio_science_east_ent.setTop(new LatLng(49.810332, -97.134465), new XYPos(-90, 132));
        bio_science_east_ent.setLeft(new LatLng(49.810287, -97.134455), new XYPos(-89, 127));
        bio_science_east_ent.setRight(new LatLng(49.810312, -97.134349), new XYPos(-82, 130));
        ...
        bio_science_west_ent.setTop(new LatLng(49.810110, -97.135071), new XYPos(-133, 108));
        bio_science_west_ent.setRight(new LatLng(49.810090, -97.135044), new XYPos(-132, 105));
        ...
        buller_west_ent.setTop(new LatLng(49.810327, -97.133548), new XYPos(-24, 132));
        buller_west_ent.setBottom(new LatLng(49.810288, -97.133519), new XYPos(-22, 127));
        ...
        buller_east_ent.setTop(new LatLng(49.810459, -97.133175), new XYPos(-3, 146));
        buller_east_ent.setBottom(new LatLng(49.810418, -97.133134), new XYPos(-6, 142));
        ...
        dairy_science.setLeft(new LatLng(49.807709, -97.133405), new XYPos(-14, -159));
        dairy_science.setRight(new LatLng(49.807729, -97.133342), new XYPos(-9, -157));
        dairy_science.setBottom(new LatLng(49.807654, -97.133320), new XYPos(-8, -166));
        ...
        drake.setBottom(new LatLng(49.808213, -97.130217), new XYPos(215, -103));
        ...
        duff_roblin_west_ent.setTop(new LatLng(49.810981, -97.133100), new XYPos(8, 205));
        duff_roblin_west_ent.setRight(new LatLng(49.810894, -97.132999), new XYPos(15, 195));
        duff_roblin_west_ent.setBottom(new LatLng(49.810765, -97.132917), new XYPos(21, 181));
        ...
        duff_roblin_south_ent.setTop(new LatLng(49.810961, -97.132287), new XYPos(66, 202));
        duff_roblin_south_ent.setLeft(new LatLng(49.810780, -97.132769), new XYPos(32, 182));
        duff_roblin_south_ent.setBottom(new LatLng(49.810875, -97.132454), new XYPos(54, 193));
        ...
        education_south_ent.setTop(new LatLng(49.808624, -97.136406), new XYPos(-229, -58));
        education_south_ent.setRight(new LatLng(49.808696, -97.136074), new XYPos(-205, -50));
        education_south_ent.setBottom(new LatLng(49.808606, -97.136228), new XYPos(-216, -60));
        ...
        education_west_ent.setRight(new LatLng(49.808452, -97.137281), new XYPos(-292, -77));
        education_west_ent.setBottom(new LatLng(49.808409, -97.137312), new XYPos(-294, -82));
        ...
        education_north_ent.setLeft(new LatLng(49.809142, -97.136583), new XYPos(-242, 0));
        education_north_ent.setRight(new LatLng(49.809199, -97.136452), new XYPos(-233, -6));
        ...
        eitc_e1_east_ent.setTop(new LatLng(49.808571, -97.132774), new XYPos(31, -64));
        eitc_e1_east_ent.setLeft(new LatLng(49.808453, -97.133077), new XYPos(10, -77));
        eitc_e1_east_ent.setBottom(new LatLng(49.808541, -97.132743), new XYPos(34, -67));
        ...
        eitc_e1_e3.setTop(new LatLng(49.808243, -97.133994), new XYPos(-56, -100));
        eitc_e1_e3.setLeft(new LatLng(49.807797, -97.133749), new XYPos(-39, -150));
        eitc_e1_e3.setRight(new LatLng(49.807840, -97.133618), new XYPos(-29, -145));
        ...
        eitc_e1_e2.setTop(new LatLng(49.808772, -97.132921), new XYPos(21, -41));
        eitc_e1_e2.setLeft(new LatLng(49.808648, -97.133257), new XYPos(-3, -55));
        eitc_e1_e2.setBottom(new LatLng(49.808745, -97.132906), new XYPos(22, -44));
        ...
        eitc_e2.setTop(new LatLng(49.809005, -97.133424), new XYPos(-15, -15));
        eitc_e2.setRight(new LatLng(49.808996, -97.133327), new XYPos(-8, -16));
        eitc_e2.setBottom(new LatLng(49.808937, -97.133421), new XYPos(-15, -23));
        ...
        eitc_e3.setLeft(new LatLng(49.808633, -97.134836), new XYPos(-117, -57));
        eitc_e3.setRight(new LatLng(49.809034, -97.133540), new XYPos(-24, -12));
        eitc_e3.setBottom(new LatLng(49.808643, -97.134489), new XYPos(-92, -56));
        ...
        eli_dafoe.setTop(new LatLng(49.809993, -97.132140), new XYPos(77, 95));
        eli_dafoe.setRight(new LatLng(49.809935, -97.131675), new XYPos(110, 88));
        eli_dafoe.setBottom(new LatLng(49.809667, -97.131876), new XYPos(96, 58));
        ...
        ext_education_west_ent.setTop(new LatLng(49.807046, -97.139406), new XYPos(-445, -233));
        ext_education_west_ent.setRight(new LatLng(49.807073, -97.139269), new XYPos(-435, -230));
        ...
        ext_education_east_ent.setTop(new LatLng(49.807774, -97.137696), new XYPos(-322, -152));
        ext_education_east_ent.setLeft(new LatLng(49.807553, -97.137825), new XYPos(-331, -177));
        ...
        fac_of_music_north_end.setTop(new LatLng(49.807675, -97.136190), new XYPos(-214, -163));
        fac_of_music_north_end.setLeft(new LatLng(49.807400, -97.136108), new XYPos(-208, -194));
        fac_of_music_north_end.setBottom(new LatLng(49.807369, -97.135997), new XYPos(-200, -197));
        ...
        fac_of_music_south_end.setLeft(new LatLng(49.807171, -97.135752), new XYPos(-182, -219));
        fac_of_music_south_end.setRight(new LatLng(49.807197, -97.135675), new XYPos(-177, -216));
        ...
        fletcher.setLeft(new LatLng(49.809476, -97.131635), new XYPos(113, 37));
        fletcher.setRight(new LatLng(49.809565, -97.131352), new XYPos(134, 47));
        ...
        helen_glass.setTop(new LatLng(49.808810, -97.135583), new XYPos(-170, -37));
        helen_glass.setLeft(new LatLng(49.808760, -97.135817), new XYPos(-187, -42));
        helen_glass.setRight(new LatLng(49.808709, -97.135467), new XYPos(-162, -48));
        helen_glass.setBottom(new LatLng(49.808640, -97.135591), new XYPos(-171, -56));
        ...
        human_eco.setTop(new LatLng(49.810810, -97.132460), new XYPos(54, 186));
        human_eco.setRight(new LatLng(49.810700, -97.132333), new XYPos(63, 173));
        human_eco.setBottom(new LatLng(49.810425, -97.132402), new XYPos(58, 143));
        ...
        isbister.setTop(new LatLng(49.809124, -97.130257), new XYPos(212, 2));
        isbister.setLeft(new LatLng(49.809064, -97.130248), new XYPos(213, -9));
        isbister.setBottom(new LatLng(49.808981, -97.130163), new XYPos(219, -18));
        ...
        parker.setTop(new LatLng(49.811516, -97.135120), new XYPos(-137, 264));
        parker.setLeft(new LatLng(49.811335, -97.135811), new XYPos(-187, 244));
        parker.setRight(new LatLng(49.811591, -97.134773), new XYPos(-112, 272));
        ...
        robert_schultz_west_ent.setTop(new LatLng(49.810215, -97.136786), new XYPos(-257, 119));
        robert_schultz_west_ent.setLeft(new LatLng(49.810097, -97.136940), new XYPos(-268, 106));
        robert_schultz_west_ent.setRight(new LatLng(49.810203, -97.136740), new XYPos(-253, 118));
        ...
        robert_schultz_south_ent.setTop(new LatLng(49.809943, -97.136340), new XYPos(-225, 89));
        robert_schultz_south_ent.setLeft(new LatLng(49.809833, -97.136435), new XYPos(-231, 77));
        robert_schultz_south_ent.setRight( new LatLng(49.809922, -97.136160), new XYPos(-212, 87));
        ...
        robson.setTop(new LatLng(49.811825, -97.131126), new XYPos(150, 298));
        robson.setRight(new LatLng(49.811758, -97.130976), new XYPos(161, 291));
        ...
        russel_north_ent.setLeft(new LatLng(49.808290, -97.135584), new XYPos(-170, -95));
        russel_north_ent.setRight(new LatLng(49.808315, -97.135499), new XYPos(-164, -92));
        russel_north_ent.setBottom(new LatLng(49.808192, -97.135455), new XYPos(-161, -106));
        ...
        russel_south_ent.setTop(new LatLng(49.807905, -97.135216), new XYPos(-144, -138));
        russel_south_ent.setBottom(new LatLng(49.807431, -97.134837), new XYPos(-117, -190));
        ...
        st_johns_west_ent.setTop(new LatLng(49.810520, -97.137185), new XYPos(-285, 153));
        st_johns_west_ent.setLeft(new LatLng(49.810438, -97.137287), new XYPos(-293, 144));
        st_johns_west_ent.setRight(new LatLng(49.810557, -97.137024), new XYPos(-274, 157));
        st_johns_west_ent.setBottom(new LatLng(49.810486, -97.137138), new XYPos(-282, 149));
        ...
        st_johns_north_ent.setLeft(new LatLng(49.810760, -97.137195), new XYPos(-286, 180));
        st_johns_north_ent.setBottom(new LatLng(49.810749, -97.137065), new XYPos(-277, 179));
        ...
        st_johns_east_ent.setLeft(new LatLng(49.811217, -97.136940), new XYPos(-268, 231));
        st_johns_east_ent.setRight(new LatLng(49.811236, -97.136876), new XYPos(-263, 233));
        st_johns_east_ent.setBottom(new LatLng(49.810898, -97.136607), new XYPos(-244, 195));
        ...
        st_pauls_north_ent.setTop(new LatLng(49.810584, -97.138266), new XYPos(-363, 160));
        st_pauls_north_ent.setBottom(new LatLng(49.810430, -97.138044), new XYPos(-347, 143));
        ...
        st_pauls_east_ent.setLeft(new LatLng(49.809888, -97.137377), new XYPos(-299, 83));
        st_pauls_east_ent.setRight(new LatLng(49.810018, -97.137080), new XYPos(-278, 97));
        st_pauls_east_ent.setBottom(new LatLng(49.809914, -97.137222), new XYPos(-288, 86));
        ...
        tier_west_ent.setTop(new LatLng(49.809159, -97.131304), new XYPos(137, 2));
        tier_west_ent.setLeft(new LatLng(49.809095, -97.131370), new XYPos(132, 5));
        tier_west_ent.setRight(new LatLng(49.809178, -97.131130), new XYPos(149, 4));
        tier_west_ent.setBottom(new LatLng(49.809110, -97.131273), new XYPos(139, 4));
        ...
        tier_south_ent.setTop(new LatLng(49.808940, -97.130745), new XYPos(177, -22));
        tier_south_ent.setLeft(new LatLng(49.808867, -97.130741), new XYPos(177, -31));
        tier_south_ent.setBottom(new LatLng(49.808847, -97.130678), new XYPos(182, -33));
        ...
        uni_centre_west_ent.setRight(new LatLng(49.809072, -97.135035), new XYPos(-131, 8));
        uni_centre_west_ent.setBottom(new LatLng(49.808910, -97.134955), new XYPos(-125, -26));
        ...
        uni_centre_east_ent.setLeft(new LatLng(49.809291, -97.133712), new XYPos(-36, 17));
        uni_centre_east_ent.setRight(new LatLng(49.809362, -97.133536), new XYPos(-23, 24));
        ...
        uni_centre_north_ent.setLeft(new LatLng(49.809455, -97.133905), new XYPos(-50, 35));
        uni_centre_north_ent.setRight(new LatLng(49.809491, -97.133766), new XYPos(-40, 39));
        uni_centre_north_ent.setBottom(new LatLng(49.809349, -97.133790), new XYPos(-41, 23));
        ...
        uni_centre_south_west_ent.setTop(new LatLng(49.808781, -97.135062), new XYPos(-133, -40));
        uni_centre_south_west_ent.setBottom(new LatLng(49.808778, -97.135052), new XYPos(-132, -40));
        ...
        uni_college.setTop(new LatLng(49.811055, -97.131105), new XYPos(151, 213));
        uni_college.setLeft(new LatLng(49.810852, -97.131118), new XYPos(150, 190));
        ...
        wallace.setTop(new LatLng(49.811658, -97.135693), new XYPos(-178, 280));
        wallace.setBottom(new LatLng(49.811608, -97.135696), new XYPos(-178, 274));
        ...
        a.setLeft(new LatLng(49.808853, -97.130508), new XYPos(194, -32));
        ...
        c.setLeft(new LatLng(49.808811, -97.130605), new XYPos(187, -37));
        ...
        d.setLeft(new LatLng(49.808804, -97.130670), new XYPos(182, -38));
        ...
        e.setBottom(new LatLng(49.808758, -97.130674), new XYPos(182, -43));
        e.setRight(d.getLeft());
        e.setLeft(new LatLng(49.808720, -97.130867), new XYPos(168, -47));
        e.setTop(new LatLng(49.808804, -97.130796), new XYPos(173, -38));
        ...
        f.setTop(new LatLng(49.808855, -97.130921), new XYPos(164, -32));
        ...
        h.setTop(new LatLng(49.808704, -97.131109), new XYPos(151, -49));
        h.setBottom(new LatLng(49.808620, -97.131126), new XYPos(150, -58));
        ...
        i.setTop(new LatLng(49.809287, -97.131564), new XYPos(118, 16));
        i.setLeft(new LatLng(49.809017, -97.131397), new XYPos(130, -14));
        ...
        j.setLeft(new LatLng(49.809350, -97.131538), new XYPos(120, 23));
        ...
        k.setTop(new LatLng(49.809341, -97.131608), new XYPos(115, 22));
        ...
        l.setTop(new LatLng(49.809546, -97.131779), new XYPos(103, 45));
        l.setRight(fletcher.getLeft());
        l.setLeft(new LatLng(49.809436, -97.131742), new XYPos(106, 33));
        ...
        m.setLeft(new LatLng(49.809418, -97.131888), new XYPos(95, 31));
        m.setBottom(new LatLng(49.809292, -97.131788), new XYPos(102, 17));
        ...
        o.setLeft(new LatLng(49.809431, -97.131995), new XYPos(87, 32));
        ...
        p.setTop(new LatLng(49.809147, -97.132927), new XYPos(20, 1));
        p.setBottom(new LatLng(49.809264, -97.132436), new XYPos(56, 14));
        ...
        q.setLeft(new LatLng(49.809061, -97.132318), new XYPos(64, -9));
        q.setRight(new LatLng(49.809080, -97.132241), new XYPos(64, -7));
        ...
        r.setRight(new LatLng(49.809092, -97.131945), new XYPos(91, -6));
        ...
        s.setRight(new LatLng(49.809071, -97.131857), new XYPos(97, -8));
        ...
        t.setTop(s.getRight());
        t.setBottom(new LatLng(49.808958, -97.131648), new XYPos(112, -20));
        ...
        u.setBottom(new LatLng(49.808901, -97.131617), new XYPos(114, -27));
        ...
        v.setBottom(new LatLng(49.808735, -97.131593), new XYPos(116, -26));
        ...
        w.setBottom(new LatLng(49.808689, -97.131614), new XYPos(115, -50));
        w.setRight(new LatLng(49.808651, -97.131208), new XYPos(144, -55));
        ...
        x.setRight(new LatLng(49.808598, -97.131203), new XYPos(144, -61));
        x.setTop(new LatLng(49.808436, -97.131724), new XYPos(107, -79));
        x.setLeft(new LatLng(49.808397, -97.131796), new XYPos(102, -83));
        ...
        z.setLeft(new LatLng(49.808577, -97.131720), new XYPos(107, -63));
        ...
        aa.setLeft(new LatLng(49.808487, -97.132148), new XYPos(76, -73));
        aa.setBottom(new LatLng(49.808468, -97.132026), new XYPos(85, -75));
        ...
        ab.setLeft(new LatLng(49.808381, -97.131848), new XYPos(98, -85));
        ...
        ac.setLeft(new LatLng(49.808185, -97.132420), new XYPos(57, -106));
        ac.setTop(new LatLng(49.808249, -97.132278), new XYPos(67, -99));
        ...
        ad.setBottom(new LatLng(49.808476, -97.132214), new XYPos(72, -74));
        ad.setTop(new LatLng(49.808630, -97.132490), new XYPos(52, -57));
        ...
        af.setTop(new LatLng(49.808864, -97.132540), new XYPos(48, -31));
        ...
        ag.setLeft(new LatLng(49.808940, -97.132896), new XYPos(23, -22));
        ag.setRight(new LatLng(49.808915, -97.132503), new XYPos(51, -25));
        ...
        ai.setTop(new LatLng(49.808329, -97.132564), new XYPos(47, -90));
        ai.setLeft(new LatLng(49.808158, -97.132680), new XYPos(38, -109));
        ai.setRight(ac.getLeft());
        ai.setBottom(new LatLng(49.808165, -97.132435), new XYPos(56, -109));
        ...
        al.setBottom(new LatLng(49.808102, -97.132385), new XYPos(59, -116));
        ...
        ap.setTop(new LatLng(49.807312, -97.134700), new XYPos(-107, -204));
        ...
        aq.setTop(new LatLng(49.807408, -97.134821), new XYPos(-115, -193));
        ...
        au.setTop(new LatLng(49.805973, -97.138556), new XYPos(-384, -352));
        ...
        ax.setLeft(new LatLng(49.807202, -97.135511), new XYPos(-165, -216));
        ...
        ay.setBottom(new LatLng(49.807156, -97.135650), new XYPos(-175, -221));
        ...
        az.setLeft(new LatLng(49.806191, -97.138524), new XYPos(-381, -328));
        az.setRight(ay.getBottom());
        az.setTop(new LatLng(49.807015, -97.136213), new XYPos(-215, -237));
        ...
        ba.setLeft(new LatLng(49.806261, -97.138778), new XYPos(-400, -320));
        ...
        bb.setTop(new LatLng(49.807064, -97.139488), new XYPos(-450, -231));
        ...
        bc.setTop(new LatLng(49.807078, -97.139433), new XYPos(-447, -230));
        ...
        bd.setTop(new LatLng(49.807186, -97.139560), new XYPos(-456, -218));
        ...
        be.setRight(new LatLng(49.807877, -97.137920), new XYPos(-338, -141));
        be.setTop(new LatLng(49.807288, -97.139629), new XYPos(-461, -206));
        ...
        bf.setRight(new LatLng(49.807283, -97.136321), new XYPos(-223, -207));
        ...
        bh.setRight(new LatLng(49.807907, -97.137624), new XYPos(-317, -137));
        ...
        bi.setRight(new LatLng(49.808271, -97.136575), new XYPos(-241, -97));
        bi.setTop(new LatLng(49.808241, -97.136807), new XYPos(-258, -100));
        bi.setBottom(new LatLng(49.808141, -97.136489), new XYPos(-235, -111));
        ...
        bk.setRight(new LatLng(49.808361, -97.136284), new XYPos(-221, -87));
        ...
        bm.setTop(new LatLng(49.808059, -97.135999), new XYPos(-200, -120));
        bm.setLeft(archi2_north_ent.getRight());
        bm.setBottom(new LatLng(49.807745, -97.136164), new XYPos(-212, -155));
        ...
        bo.setTop(new LatLng(49.808279, -97.135949), new XYPos(-196, -96));
        bo.setRight(new LatLng(49.808183, -97.135918), new XYPos(-194, -107));
        ...
        bp.setTop(new LatLng(49.808280, -97.135670), new XYPos(-176, -96));
        ...
        bq.setLeft(new LatLng(49.808392, -97.135795), new XYPos(-185, -83));
        bq.setRight(new LatLng(49.808402, -97.135728), new XYPos(-181, -82));
        ...
        br.setLeft(new LatLng(49.808306, -97.136012), new XYPos(-201, -93));
        br.setBottom(bo.getTop());
        br.setRight(bq.getLeft());
        br.setTop(new LatLng(49.808437, -97.135851), new XYPos(-189, -78));
        ...
        bs.setTop(new LatLng(49.808419, -97.136262), new XYPos(-219, -80));
        ...
        bt.setTop(bs.getTop());
        bt.setRight(new LatLng(49.808568, -97.136101), new XYPos(-207, -64));
        ...
        bu.setTop(new LatLng(49.808605, -97.136014), new XYPos(-201, -60));
        ...
        bv.setTop(new LatLng(49.808721, -97.136014), new XYPos(-201, -47));
        ...
        bw.setTop(new LatLng(49.808397, -97.135377), new XYPos(-155, -83));
        ...
        bx.setTop(new LatLng(49.808529, -97.135567), new XYPos(-169, -68));
        bx.setRight(new LatLng(49.808463, -97.135508), new XYPos(-165, -76));
        ...
        bz.setRight(new LatLng(49.808617, -97.135022), new XYPos(-130, -58));
        ...
        ca.setLeft(new LatLng(49.808741, -97.135127), new XYPos(-137, -45));
        ca.setBottom(new LatLng(49.808738, -97.135035), new XYPos(-131, -45));
        ...
        cb.setRight(new LatLng(49.808748, -97.134871), new XYPos(-119, -44));
        ...
        cd.setRight(new LatLng(49.808953, -97.134693), new XYPos(-106, -21));
        ...
        ce.setRight(new LatLng(49.809129, -97.134215), new XYPos(-72, -1));
        ...
        cf.setBottom(new LatLng(49.809141, -97.133597), new XYPos(-28, 0));
        ...
        cg.setRight(new LatLng(49.809058, -97.133384), new XYPos(-12, -9));
        ...
        ch.setTop(new LatLng(49.809016, -97.133126), new XYPos(6, -14));
        ch.setRight(new LatLng(49.808905, -97.132985), new XYPos(16, -26));
        ...
        cj.setTop(new LatLng(49.809077, -97.133165), new XYPos(3, -7));
        ...
        ck.setTop(new LatLng(49.809142, -97.133212), new XYPos(0, 0));
        ...
        cl.setTop(new LatLng(49.809507, -97.133477), new XYPos(-19, 41));
        ...
        cm.setTop(new LatLng(49.809848, -97.133752), new XYPos(-39, 79));
        cm.setRight(new LatLng(49.809859, -97.133622), new XYPos(-29, 80));
        ...
        cn.setTop(new LatLng(49.810234, -97.134121), new XYPos(-65, 121));
        cn.setRight(new LatLng(49.810139, -97.133881), new XYPos(-48, 111));
        ...
        co.setRight(new LatLng(49.810274, -97.133466), new XYPos(-18, 126));
        co.setBottom(new LatLng(49.810238, -97.133482), new XYPos(-19, 122));
        ...
        cp.setRight(new LatLng(49.810384, -97.133138), new XYPos(-5, 138));
        cp.setBottom(new LatLng(49.810311, -97.133283), new XYPos(-5, 130));
        ...
        cq.setBottom(new LatLng(49.810374, -97.133095), new XYPos(-8, 137));
        cq.setLeft(cp.getRight());
        cq.setRight(new LatLng(49.810506, -97.132747), new XYPos(33, 152));
        ...
        cr.setTop(new LatLng(49.809900, -97.133574), new XYPos(-26, 84));
        cr.setRight(new LatLng(49.810189, -97.132649), new XYPos(40, 116));
        ...
        cs.setRight(new LatLng(49.810233, -97.133400), new XYPos(-13, 121));
        cs.setBottom(new LatLng(49.810191, -97.133440), new XYPos(-16, 117));
        ...
        cu.setRight(new LatLng(49.810328, -97.133116), new XYPos(-7, 132));
        ...
        cv.setBottom(new LatLng(49.810318, -97.133030), new XYPos(-13, 131));
        ...
        cw.setRight(new LatLng(49.810230, -97.132519), new XYPos(50, 121));
        ...
        cx.setTop(new LatLng(49.810384, -97.132566), new XYPos(46, 138));
        cx.setLeft(cw.getRight());
        cx.setRight(new LatLng(49.810396, -97.132415), new XYPos(57, 139));
        ...
        cy.setTop(new LatLng(49.810641, -97.132802), new XYPos(29, 167));
        ...
        dd.setTop(new LatLng(49.810405, -97.134235), new XYPos(-73, 140));
        ...
        df.setLeft(new LatLng(49.810412, -97.134578), new XYPos(-98, 141));
        ...
        dg.setLeft(new LatLng(49.810209, -97.135130), new XYPos(-138, 119));
        ...
        dh.setLeft(new LatLng(49.810131, -97.135299), new XYPos(-150, 110));
        ...
        di.setTop(new LatLng(49.810206, -97.135508), new XYPos(-165, 118));
        di.setLeft(new LatLng(49.810080, -97.135680), new XYPos(-177, 104));
        ...
        dk.setTop(new LatLng(49.810354, -97.135384), new XYPos(-156, 135));
        ...
        dl.setTop(new LatLng(49.811221, -97.136078), new XYPos(-206, 231));
        dl.setBottom(dk.getTop());
        dl.setRight(new LatLng(49.810686, -97.135648), new XYPos(-175, 172));
        ...
        dm.setTop(new LatLng(49.811341, -97.135821), new XYPos(-187, 245));
        dm.setRight(parker.getLeft());
        dm.setLeft(new LatLng(49.811282, -97.136095), new XYPos(-207, 238));
        ...
        dn.setTop(new LatLng(49.811414, -97.136219), new XYPos(-216, 253));
        ...
        dq.setRight(new LatLng(49.811528, -97.135902), new XYPos(-193, 265));
        ...
        dr.setTop(new LatLng(49.811570, -97.135836), new XYPos(-188, 270));
        ...
        ds.setRight(new LatLng(49.811553, -97.135272), new XYPos(-148, 268));
        ...
        dt.setBottom(new LatLng(49.811579, -97.135171), new XYPos(-141, 271));
        ...
        dv.setTop(new LatLng(49.811036, -97.137669), new XYPos(-320, 211));
        dv.setLeft(new LatLng(49.810917, -97.137856), new XYPos(-333, 197));
        dv.setRight(st_johns_east_ent.getLeft());
        dv.setBottom(new LatLng(49.810979, -97.137597), new XYPos(-315, 204));
        ...
        dw.setLeft(new LatLng(49.810832, -97.137564), new XYPos(-312, 188));
        dw.setTop(dv.getBottom());
        dw.setBottom(new LatLng(49.810791, -97.137452), new XYPos(-304, 183));
        ...
        dx.setLeft(new LatLng(49.810871, -97.137991), new XYPos(-343, 192));
        ...
        dy.setBottom(new LatLng(49.810719, -97.138378), new XYPos(-371, 175));
        ...
        ea.setBottom(new LatLng(49.810609, -97.137357), new XYPos(-298, 163));
        ...
        eb.setBottom(new LatLng(49.810545, -97.137339), new XYPos(-296, 156));
        ...
        ec.setBottom(new LatLng(49.810125, -97.137179), new XYPos(-285, 109));
        ...
        ed.setBottom(new LatLng(49.810038, -97.136942), new XYPos(-268, 100));
        ...
        ee.setRight(new LatLng(49.809749, -97.136681), new XYPos(-249, 68));
        ee.setLeft(new LatLng(49.809737, -97.136764), new XYPos(-255, 66));
        ...
        eg.setBottom(new LatLng(49.809763, -97.136915), new XYPos(-266, 69));
        ...
        eh.setBottom(new LatLng(49.809265, -97.136474), new XYPos(-234, 14));
        ...
        ei.setBottom(new LatLng(49.808828, -97.136078), new XYPos(-206, -35));
